defmodule AoC2023.Day07.Part2 do
  @moduledoc """
    @see https://adventofcode.com/2023/day/7#part2
  """
  ...
  defp with_frequencies({hand, bid}) do
    freqs = Enum.frequencies(hand)
    joker = Map.get(freqs, @joker, 0)

    {hand, bid, freqs |> Map.delete(@joker) |> Map.values() |> Enum.sort(:desc) |> add(joker)}
  end

  defp add([], jocker), do: [jocker]
  defp add([best | rest], jocker), do: [best + jocker | rest]
